...
const broadcasts = [
  {
    ...
    duration: "8 hours",
    details:
      "Multi-camera production with instant replays, live graphics, and remote commentary integration",
  },
  {
    ...
    duration: "6 hours",
    details:
      "Live tournament coverage with player cams, game capture, and automated score overlays",
  },
  {
    ...
    duration: "24 hours",
    details:
      "24-hour charity stream with donation tracking, multiple game feeds, and guest segments",
  },
  {
    ...
    duration: "10 hours",
    details:
      "High-stakes qualifier with multi-angle coverage and real-time statistics integration",
  },
  {
    ...
    duration: "5 hours",
    details:
      "Finals coverage with instant replay highlights and crowd camera feeds",
  },
  {
    ...
    duration: "4 hours",
    details:
      "Custom graphics package and automated scene switching for showmatch series",
  },
];
