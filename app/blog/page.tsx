...
const posts = [
  {
    ...
    description: "Thoughts on building efficient database indexes for applications that need to scale.",
    date: "2024-03-15",
  ...
  },
  {
    ...
    description: "How to inject custom assets into Unity games at runtime without modifying game files.",
    date: "2024-03-10",
    tags: ["Unity", "Modding"],
  ...
  },
  {
    ...
    description: "Creating a web-based control interface for live video production with WebSockets.",
    date: "2024-03-05",
  ...
  },
  {
    ...
    description: "My workflow for creating optimized 3D assets that look good and run fast.",
    date: "2024-02-28",
    tags: ["3D", "Game Dev"],
  ...
  },
  {
    ...
    description: "Using TouchDesigner to create reactive lighting shows controlled via DMX.",
    date: "2024-02-20",
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">Random thoughts and notes on things I'm working on.</p>
            </div>
                  ...
                  <Card className="border-border bg-card hover:border-accent transition-colors group">
                    ...
                    <CardContent>
                      <div className="flex flex-wrap gap-2">
                        {post.tags.map((tag) => (
                          <span key={tag} className="text-xs px-2 py-1 bg-secondary border border-border">
                            {tag}
                          </span>
                        ))}
                      </div>
